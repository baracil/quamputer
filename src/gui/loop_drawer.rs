...
use crate::operation::LoopPar;
use raylib::drawing::RaylibDraw;
use raylib::math::{Vector2, Rectangle};
use std::panic::panic_any;
use raylib::color::Color;

impl Drawable for LoopPar {
    ...
    fn draw(&self, drawer: &mut impl RaylibDraw, pos:Vector2, parameter:&DrawingPar) -> Vector2 {
        let mut pos_final = {
            ...
            self.operation.draw(drawer, pos_start, parameter)
        };
        ...
        let mut rect  = Rectangle::new(pos.x+parameter.margin,pos.y-parameter.register_spacing,loop_width,loop_height);
...

        {
            ...
            for nb_qbit in 0..parameter.nb_qbits {
                pos1.x = pos.x;
